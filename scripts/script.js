...
const descriptions = new Map([
    ...
    ['scprecreation', {
        ...
        description: '<img src="media/images/scp/1.png" style="--floatVal: left" alt="Screenshot of a Unity instance showcasing an environment which seems to be a room - a room for containing prisoners">I\'m still working on this project. So far I\'ve only built one room (using a reference dummy model), considering I\'m trying to understand modelling software and how all rooms were designed in this project. A lot of things are functional, such as doors, conveyors and even mirrors that have been placed around this one particular room. It\'s also the project where I\'ve experimented with baked lighting quite a lot and my god it can look good under certain conditions.<br><br>No links, check gallery! I even included an experimental room, very liminal and spooky.',
        screenshotCount: 5,
        screenshotDir: 'media/images/scp/'
    }]
])
