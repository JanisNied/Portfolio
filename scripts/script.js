...
const descriptions = new Map([
    ['cakegame', {
        name: 'Unnamed project for \'Liepājas Dzimšanas Dienas torte 2024\' competition <div class="logo" style="--logoURL: url(\'/media/images/Godot_icon.svg\')"></div>',
        type: 'Type: Game',
    ...
    ['nullworkbonelab', {
        name: 'Nullwork <div class="logo" style="--logoURL: url(\''+repoName+'/media/images/bllogo.png\')"></div><div class="logo" style="--logoURL: url(\'/media/images/unity.png\')"></div>',
    ...
    ['bananapeel', {
        name: 'Banana Peel <div class="logo" style="--logoURL: url(\'/media/images/bllogo.png\')"></div><div class="logo" style="--logoURL: url(\'/media/images/unity.png\')"></div>',
        type: 'Type: Game modification',
